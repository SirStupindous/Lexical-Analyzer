...
class Lexer:
    ...
    """
    def __init__(self, reserved_word_list_table, token_table, scanning_table):
        """
        Sets the class variables for the tables and source code.
        """
        self.reserved_word_list_table = reserved_word_list_table
    ...
    def main(token_tuple, self): 
        print("Token Type:" + token_tuple)
        print("Lexeme: " + self)